...
namespace StargateUnitTests.Business.Commands
{
    public class CreatePersonTests
    {
        ...
        private readonly Mock<ILogHelper> _logHelper = new();
        ...
        {
            _preProcessor = new CreatePersonPreProcessor(context, _logHelper.Object);
        }

        private void CreateHandlerService(StargateContext context)
        {
            _handler = new CreatePersonHandler(context, _logHelper.Object);
        }
    }
}